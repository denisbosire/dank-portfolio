...
function aqua_portfolio_scripts() {
	...
	wp_enqueue_script( 'dank-portfolio-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'dank-portfolio-smoothloader', get_template_directory_uri() . '/js/smoothstate.js', array('jquery'), '209981215', true );
